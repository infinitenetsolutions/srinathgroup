...
<body>
                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="nav-menu-items">
                            <ul class="nav-items">
                                ...
                                <li class="menu-item-has-no-child"><a href="contact.html">Contact1</a></li>
                            </ul>
                        </div>
                            ...
                            <ul class="navbar-nav">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item-has-children"><a href="#">Leadership</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="md_corner.php">MD's Corner</a></li>
                                                <li><a href="founder_corner.php">Founder Corner</a></li>
                                                <li><a href="chairman_corner.php">Chairman’s Corner</a></li>
                                                <li><a href="Tables-UI.html">Core Values</a></li>
                                                <li><a href="Forms-UI.html">Mission</a></li>
                                                <li><a href="Alerts%26Cookies-UI.html">Vission</a>
                                                <li><a href="Model-UI.html">History</a></li>
                                                <li><a href="Pagination-UI.html">Response to COVID-19</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="all-courses.html">Video Gallery</a></li>
                                        <li><a href="course-detail.html">News</a></li>
                                    </ul>
                                </li>
                                <li class="menu-item-has-no-children">
    ...
    <div class="navbar-mobile sticky-bar d-block d-sm-none">
        <div class="container-fluid">
            ...
            <div class="language">
                <div class="dropdown">
                    <button class="active" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="flag" src="assets/img/icons/Flags/united-kingdom.png" alt="cuntry flag" />
                    </button>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                        <button class="dropdown-item" type="button"><img src="assets/img/icons/Flags/france.png" alt="flag image" class="flag" /></button>
                        <button class="dropdown-item" type="button"><img src="assets/img/icons/Flags/germany.png" alt="flag image" class="flag" /></button>
                        <button class="dropdown-item" type="button"><img src="assets/img/icons/Flags/japan.png" alt="flag image" class="flag" /></button>
                    </div>
                </div>
            </div>
            <div class="divider"></div>
        ...
        <div class="nav-menu-items">
            <ul class="nav-items">
                ...
                <li class="menu-item-has-no-child"><a href="contact.html">Contact3</a></li>
            </ul>
        </div>
