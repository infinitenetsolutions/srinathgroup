  ...
  $description = simplename($_POST['description']);
      if ($cat != null) {
        ...
        //     if (is_uploaded_file($_FILES['Image']['tmp_name'])) {
                ...
                $sql = "INSERT INTO `jag_investor`(`title`,`description`,`image`) VALUES ('$title','$description','$imgData')";
...
$select1 = "SELECT * FROM `jag_investor`";
        ...
        <div class="modal-content" >
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold" style="color: #f72000;">Add Investor</h4>
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button name="insert" class="btn btn-success" >Add Investor</button>
                </div>
            </form>
        </div>
    </div>
