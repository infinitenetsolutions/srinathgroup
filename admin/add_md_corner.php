        ...
        if (count($_FILES) > 0) {
            if (is_uploaded_file($_FILES['Image']['tmp_name'])) {
                ...
                if ($current_id) {
                    ...
                    echo "<script>
                    setTimeout(function() {
                        window.location.replace('md_corner.php');
        ...
        <div class="modal-content" style="">
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold" style="">Add MD</h4>
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button name="insert" class="btn btn-success" style="">Add MD Corner</button>
                </div>
            </form>
        </div>
    </div>
