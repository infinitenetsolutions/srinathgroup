      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1>Manage Founder Corner</h1>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active">Founder Corner</li>
                </ol>
              </div>
            </div>
          </div><!-- /.container-fluid -->
              ...
              <div class="card">
                ...
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Founder Corner</h3>
                  </div>
                  <!-- /.card-header -->
                  ...
                  <div class="card-body">
                  <a href="" class="btn btn-primary text-center" data-toggle="modal" data-target="#add_secretary" style="background:#e10d0d">Add Founder</a>
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr>
                              ...
                              <td><a href="update_founder.php?edit=<?php echo $rowimage['id']; ?>" class="btn btn-warning">Update</a>
                              <td> <a href="delete_founder.php?delete=<?php echo $rowimage['id']; ?>" class="btn btn-danger">Delete</a>
                            </tr>
                        <?php 
                        $cnt++;
                        }  ?>
